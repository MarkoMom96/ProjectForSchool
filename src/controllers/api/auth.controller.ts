...
export class AuthController {
    ...
    async doProfessorLogin(@Body() data: LoginDto, @Req() req: Request): Promise<LoginInfoDto | ApiResponse> {
        ...
        const refreshToken: string = jwt.sign(jwtRefreshData.toPlainObj(), jtwSecret );
    ...
    async ProfessorTokenRefresh(@Req() req: Request, @Body() data: RefreshTokenDto): Promise<LoginInfoDto | ApiResponse>{
      const professorToken = await this.professorService.getProfessorToken(data.token);
    ...
    async StudentTokenRefresh(@Req() req: Request, @Body() data: RefreshTokenDto): Promise<LoginInfoDto | ApiResponse>{
