...
import { UserRefreshTokenDto } from "src/dtos/auth/student.refresh.token.dto";
...
export class AuthController {
    ...
    @Post('professor/login') // localhost:3000/auth/login
    async doProfessorLogin(@Body() data: LoginDto, @Req() req: Request): Promise<LoginInfoDto | ApiResponse> {
        ...
        jwtData.exp = this.getExpireDate(60 * 60 * 24 * 7);
    ...
    @Post('student/login') // localhost:3000/auth/login
